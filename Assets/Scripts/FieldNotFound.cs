using UnityEngine;
public sealed class JSONObject.FieldNotFound : MulticastDelegate
{
    // Methods
    public JSONObject.FieldNotFound(object object, IntPtr method)
    {
        mem[1152921511122713920] = object;
        mem[1152921511122713928] = method;
        mem[1152921511122713904] = method;
    }
