...
namespace I2.Loc.SimpleJSON
{
    public class JSONNode
    {
        ...
        {
            null = null;
            goto typeof(I2.Loc.SimpleJSON.JSONNode).__il2cppRuntimeField_150;
        }
        ...
        {
            typeof(I2.Loc.SimpleJSON.JSONData).__il2cppRuntimeField_10 = X1;
            return (I2.Loc.SimpleJSON.JSONNode)new System.Object();
        }
        public static string op_Implicit(I2.Loc.SimpleJSON.JSONNode d)
        {
            if((I2.Loc.SimpleJSON.JSONNode.op_Equality(a:  d, b:  null)) != false)
            {
                    return 0;
            }
        ...
        internal static string Escape(string aText)
        {
            ...
            var val_9 = 25814824 + (val_4 < '' ? ((val_2 & 65535) - 1) : 0) << 2;
            val_9 = val_9 + 25814824;
            goto (25814824 + (val_4 < '' ? ((val_2 & 65535) - 1) : 0) << 2 + 25814824);
        }
        public static I2.Loc.SimpleJSON.JSONNode Parse(string aJSON)
        {
            ...
            var val_47;
            var val_48;
            I2.Loc.SimpleJSON.JSONNode val_49;
            var val_50;
            var val_51;
            var val_52;
            var val_53;
            ...
            if((25815504 + (((val_3 & 65535) - 9)) << 2) > 9)
            {
                    return (I2.Loc.SimpleJSON.JSONNode)0;
            }
            
            var val_46 = 25814876 + (25815504 + (((val_3 & 65535) - 9)) << 2) << 2;
            val_46 = val_46 + 25814876;
            goto (25814876 + (25815504 + (((val_3 & 65535) - 9)) << 2) << 2 + 25814876);
            label_7:
            ...
            I2.Loc.SimpleJSON.JSONArray val_9 = null;
            val_49 = val_9;
            val_9 = new I2.Loc.SimpleJSON.JSONArray();
            if(null != 0)
            {
                goto label_94;
            }
            ...
            var val_47 = 25814916 + ((val_13 < '' ? ((val_11 & 65535) - 36) : 0 - 78)) << 2;
            val_47 = val_47 + 25814916;
            goto (25814916 + ((val_13 < '' ? ((val_11 & 65535) - 36) : 0 - 78)) << 2 + 25814916);
            label_10:
            if((val_4 - 32) > '')
            {
                goto label_22;
            ...
            if((25815524 + (((val_3 & 65535) - 32)) << 2) > 14)
            {
                goto label_21;
            }
            
            if((25815524 + (((val_3 & 65535) - 32)) << 2) == 0)
            {
                goto label_22;
            }
            
            if((25815524 + (((val_3 & 65535) - 32)) << 2) != 7)
            {
                    return (I2.Loc.SimpleJSON.JSONNode)0;
            }
            ...
            goto label_115;
            label_21:
            if((25815524 + (((val_3 & 65535) - 32)) << 2) == 16)
            {
                goto label_27;
            }
            
            if((25815524 + (((val_3 & 65535) - 32)) << 2) != 15)
            {
                    return (I2.Loc.SimpleJSON.JSONNode)0;
            }
            ...
            val_48 = mem[25815536 + (((val_3 & 65535) - 123)) << 2];
            val_48 = 25815536 + (((val_3 & 65535) - 123)) << 2;
            if(val_48 > 17)
            {
                goto label_30;
            }
            ...
            I2.Loc.SimpleJSON.JSONNode val_18 = Pop();
            val_52 = null;
            val_52 = null;
            ...
            I2.Loc.SimpleJSON.JSONNode val_22 = I2.Loc.SimpleJSON.JSONNode.op_Implicit(s:  val_21);
            if(0 != 0)
            {
                goto label_48;
            }
            ...
            I2.Loc.SimpleJSON.JSONNode val_25 = I2.Loc.SimpleJSON.JSONNode.op_Implicit(s:  val_24);
            if(0 != 0)
            {
                goto label_68;
            }
            ...
            goto label_115;
            label_84:
            I2.Loc.SimpleJSON.JSONClass val_35 = null;
            val_49 = val_35;
            val_35 = new I2.Loc.SimpleJSON.JSONClass();
            if(null != 0)
            {
                goto label_94;
            }
            ...
            label_94:
            Push(t:  val_49);
            if((I2.Loc.SimpleJSON.JSONNode.op_Equality(a:  new System.Collections.Generic.Stack<I2.Loc.SimpleJSON.JSONNode>(), b:  0)) != true)
            {
                    val_57 = null;
                val_57 = null;
                if((System.String.op_Inequality(a:  0, b:  System.String.Empty.Trim())) != false)
            {
                    I2.Loc.SimpleJSON.JSONNode val_40 = Peek();
                if(0 != 0)
            {
                goto label_105;
            }
            ...
            label_109:
            I2.Loc.SimpleJSON.JSONNode val_44 = Peek();
            goto label_115;
            label_68:
            val_61 = null;
            val_61 = null;
        ...
        public void SaveToStream(System.IO.Stream aData)
        {
            ...
            goto typeof(I2.Loc.SimpleJSON.JSONNode).__il2cppRuntimeField_2D0;
        }
        ...
        public static I2.Loc.SimpleJSON.JSONNode Deserialize(System.IO.BinaryReader aReader)
        {
            ...
            {
                    return (I2.Loc.SimpleJSON.JSONNode);
            }
            
            var val_13 = 25814932 + (val_2 < 0x7 ? ((X1 & 255) + 2) : 0) << 2;
            val_13 = val_13 + 25814932;
            goto (25814932 + (val_2 < 0x7 ? ((X1 & 255) + 2) : 0) << 2 + 25814932);
        }
        ...
        public static I2.Loc.SimpleJSON.JSONNode LoadFromStream(System.IO.Stream aData)
        {
            ...
            if(32 == 32)
            {
                    return (I2.Loc.SimpleJSON.JSONNode)I2.Loc.SimpleJSON.JSONNode.Deserialize(aReader:  val_1 = new System.IO.BinaryReader(input:  X1));
            }
        ...
        public static I2.Loc.SimpleJSON.JSONNode LoadFromBase64(string aBase64)
        {
            if(null != 0)
            {
                    return I2.Loc.SimpleJSON.JSONNode.LoadFromStream(aData:  new System.IO.MemoryStream(buffer:  System.Convert.FromBase64String(s:  0)));
            }
