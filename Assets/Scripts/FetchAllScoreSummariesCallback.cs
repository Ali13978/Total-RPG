using UnityEngine;
internal sealed class LeaderboardManager.FetchAllScoreSummariesCallback : MulticastDelegate
{
    // Methods
    public LeaderboardManager.FetchAllScoreSummariesCallback(object object, IntPtr method)
    {
        mem[1152921511979190832] = object;
        mem[1152921511979190840] = method;
        mem[1152921511979190816] = method;
    }
