...
{
    public class AttackSpeedBoostUI : GameUIBase
    {
        // Fields
        ...
        private void Update()
        {
            ...
            TzarGames.Endless.AttackSpeedBoostTimer val_3 = this._playerCharacter.AttackSpeedBoost;
