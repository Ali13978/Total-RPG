...
{
    public sealed class TG_GameObjectDelegate : MulticastDelegate
    {
        // Methods
        public TG_GameObjectDelegate(object object, IntPtr method)
        {
            mem[1152921511237560576] = object;
            mem[1152921511237560584] = method;
            mem[1152921511237560560] = method;
        }
        public virtual void Invoke(UnityEngine.GameObject obj)
        {
            var val_13;
            var val_14;
            var val_15;
