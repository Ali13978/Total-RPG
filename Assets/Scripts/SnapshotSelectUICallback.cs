using UnityEngine;
internal sealed class SnapshotManager.SnapshotSelectUICallback : MulticastDelegate
{
    // Methods
    public SnapshotManager.SnapshotSelectUICallback(object object, IntPtr method)
    {
        mem[1152921512023814064] = object;
        mem[1152921512023814072] = method;
        mem[1152921512023814048] = method;
    }
