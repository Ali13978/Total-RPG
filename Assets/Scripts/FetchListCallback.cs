using UnityEngine;
internal sealed class PlayerManager.FetchListCallback : MulticastDelegate
{
    // Methods
    public PlayerManager.FetchListCallback(object object, IntPtr method)
    {
        mem[1152921511997847344] = object;
        mem[1152921511997847352] = method;
        mem[1152921511997847328] = method;
    }
