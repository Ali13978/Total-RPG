using UnityEngine;
internal sealed class SnapshotManager.FetchAllCallback : MulticastDelegate
{
    // Methods
    public SnapshotManager.FetchAllCallback(object object, IntPtr method)
    {
        mem[1152921512021825456] = object;
        mem[1152921512021825464] = method;
        mem[1152921512021825440] = method;
    }
