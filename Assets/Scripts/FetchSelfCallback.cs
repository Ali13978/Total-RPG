using UnityEngine;
internal sealed class PlayerManager.FetchSelfCallback : MulticastDelegate
{
    // Methods
    public PlayerManager.FetchSelfCallback(object object, IntPtr method)
    {
        mem[1152921511996853040] = object;
        mem[1152921511996853048] = method;
        mem[1152921511996853024] = method;
    }
