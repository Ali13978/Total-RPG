using UnityEngine;
internal sealed class RealTimeEventListenerHelper.OnP2PDisconnectedCallback : MulticastDelegate
{
    // Methods
    public RealTimeEventListenerHelper.OnP2PDisconnectedCallback(object object, IntPtr method)
    {
        mem[1152921512002581296] = object;
        mem[1152921512002581304] = method;
        mem[1152921512002581280] = method;
    }
