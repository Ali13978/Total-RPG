using UnityEngine;
public sealed class GameManager.dlgGetParameters : MulticastDelegate
{
    // Methods
    public GameManager.dlgGetParameters(object object, IntPtr method)
    {
        mem[1152921511332661648] = object;
        mem[1152921511332661656] = method;
        mem[1152921511332661632] = method;
    }
