using UnityEngine;
internal sealed class VideoManager.IsCaptureAvailableCallback : MulticastDelegate
{
    // Methods
    public VideoManager.IsCaptureAvailableCallback(object object, IntPtr method)
    {
        mem[1152921512044765616] = object;
        mem[1152921512044765624] = method;
        mem[1152921512044765600] = method;
    }
