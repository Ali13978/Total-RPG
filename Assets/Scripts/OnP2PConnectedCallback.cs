using UnityEngine;
internal sealed class RealTimeEventListenerHelper.OnP2PConnectedCallback : MulticastDelegate
{
    // Methods
    public RealTimeEventListenerHelper.OnP2PConnectedCallback(object object, IntPtr method)
    {
        mem[1152921512002075952] = object;
        mem[1152921512002075960] = method;
        mem[1152921512002075936] = method;
    }
