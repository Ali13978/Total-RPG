using UnityEngine;
public sealed class AssetBundleManager.OverrideBaseDownloadingURLDelegate : MulticastDelegate
{
    // Methods
    public AssetBundleManager.OverrideBaseDownloadingURLDelegate(object object, IntPtr method)
    {
        mem[1152921511641699936] = object;
        mem[1152921511641699944] = method;
        mem[1152921511641699920] = method;
    }
    public virtual string Invoke(string bundleName)
    {
        var val_13;
        var val_14;
        var val_15;
    ...
    public virtual System.IAsyncResult BeginInvoke(string bundleName, System.AsyncCallback callback, object object)
    {
