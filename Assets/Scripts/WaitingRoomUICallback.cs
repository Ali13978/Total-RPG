using UnityEngine;
internal sealed class RealTimeMultiplayerManager.WaitingRoomUICallback : MulticastDelegate
{
    // Methods
    public RealTimeMultiplayerManager.WaitingRoomUICallback(object object, IntPtr method)
    {
        mem[1152921512009800880] = object;
        mem[1152921512009800888] = method;
        mem[1152921512009800864] = method;
    }
