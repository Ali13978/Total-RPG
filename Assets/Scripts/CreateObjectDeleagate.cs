using UnityEngine;
public sealed class Pool.CreateObjectDeleagate<T> : MulticastDelegate
{
    // Methods
    public Pool.CreateObjectDeleagate<T>(object object, IntPtr method)
    {
        mem[1152921511151273408] = object;
        mem[1152921511151273416] = method;
        mem[1152921511151273392] = method;
    }
