using UnityEngine;
internal sealed class VideoManager.CaptureCapabilitiesCallback : MulticastDelegate
{
    // Methods
    public VideoManager.CaptureCapabilitiesCallback(object object, IntPtr method)
    {
        mem[1152921512043771312] = object;
        mem[1152921512043771320] = method;
        mem[1152921512043771296] = method;
    }
