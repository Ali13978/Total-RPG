using UnityEngine;
internal sealed class LeaderboardManager.FetchScorePageCallback : MulticastDelegate
{
    // Methods
    public LeaderboardManager.FetchScorePageCallback(object object, IntPtr method)
    {
        mem[1152921511978196528] = object;
        mem[1152921511978196536] = method;
        mem[1152921511978196512] = method;
    }
