using UnityEngine;
internal sealed class RealTimeMultiplayerManager.RealTimeRoomCallback : MulticastDelegate
{
    // Methods
    public RealTimeMultiplayerManager.RealTimeRoomCallback(object object, IntPtr method)
    {
        mem[1152921512007282352] = object;
        mem[1152921512007282360] = method;
        mem[1152921512007282336] = method;
    }
