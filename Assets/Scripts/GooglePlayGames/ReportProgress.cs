...
{
    internal sealed class ReportProgress : MulticastDelegate
    {
        // Methods
        public ReportProgress(object object, IntPtr method)
        {
            mem[1152921511895415904] = object;
            mem[1152921511895415912] = method;
            mem[1152921511895415888] = method;
        }
        public virtual void Invoke(string id, double progress, System.Action<bool> callback)
        {
            var val_13;
            var val_14;
            var val_15;
        ...
        public virtual System.IAsyncResult BeginInvoke(string id, double progress, System.Action<bool> callback, System.AsyncCallback _callback, object object)
        {
