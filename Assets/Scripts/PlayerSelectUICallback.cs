using UnityEngine;
internal sealed class TurnBasedMultiplayerManager.PlayerSelectUICallback : MulticastDelegate
{
    // Methods
    public TurnBasedMultiplayerManager.PlayerSelectUICallback(object object, IntPtr method)
    {
        mem[1152921512039865008] = object;
        mem[1152921512039865016] = method;
        mem[1152921512039864992] = method;
    }
