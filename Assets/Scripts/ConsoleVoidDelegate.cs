using UnityEngine;
public sealed class ConsoleGUI.ConsoleVoidDelegate : MulticastDelegate
{
    // Methods
    public ConsoleGUI.ConsoleVoidDelegate(object object, IntPtr method)
    {
        mem[1152921511071473120] = object;
        mem[1152921511071473128] = method;
        mem[1152921511071473104] = method;
    }
