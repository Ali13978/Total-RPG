using UnityEngine;
internal sealed class AndroidPlatformConfiguration.OnLaunchedWithSnapshotCallback : MulticastDelegate
{
    // Methods
    public AndroidPlatformConfiguration.OnLaunchedWithSnapshotCallback(object object, IntPtr method)
    {
        mem[1152921511960301872] = object;
        mem[1152921511960301880] = method;
        mem[1152921511960301856] = method;
    }
