using UnityEngine;
internal sealed class AndroidPlatformConfiguration.OnLaunchedWithQuestCallback : MulticastDelegate
{
    // Methods
    public AndroidPlatformConfiguration.OnLaunchedWithQuestCallback(object object, IntPtr method)
    {
        mem[1152921511960799024] = object;
        mem[1152921511960799032] = method;
        mem[1152921511960799008] = method;
    }
