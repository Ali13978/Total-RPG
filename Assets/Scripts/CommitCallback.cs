using UnityEngine;
internal sealed class SnapshotManager.CommitCallback : MulticastDelegate
{
    // Methods
    public SnapshotManager.CommitCallback(object object, IntPtr method)
    {
        mem[1152921512022819760] = object;
        mem[1152921512022819768] = method;
        mem[1152921512022819744] = method;
    }
