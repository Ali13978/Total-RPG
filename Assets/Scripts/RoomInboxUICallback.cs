using UnityEngine;
internal sealed class RealTimeMultiplayerManager.RoomInboxUICallback : MulticastDelegate
{
    // Methods
    public RealTimeMultiplayerManager.RoomInboxUICallback(object object, IntPtr method)
    {
        mem[1152921512008806576] = object;
        mem[1152921512008806584] = method;
        mem[1152921512008806560] = method;
    }
