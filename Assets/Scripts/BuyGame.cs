using UnityEngine;
private class GameUI.BuyGame : GameUI.UiBaseState
{
    // Methods
    public GameUI.BuyGame()
    {
    ...
    public override void OnStateBegin(StateMachine.State prevState)
    {
        ...
        this.ShowOnlyThisMenu(menuToShow:  val_1.buyGameUI);
    ...
    public override void OnStateEnd(StateMachine.State nextState)
    {
        ...
        TzarGames.Endless.UI.GameUI val_1 = this.UI;
        this.UI.showMenu(menu:  val_2.buyGameUI, show:  false);
