using UnityEngine;
internal sealed class StatsManager.FetchForPlayerCallback : MulticastDelegate
{
    // Methods
    public StatsManager.FetchForPlayerCallback(object object, IntPtr method)
    {
        mem[1152921512027616432] = object;
        mem[1152921512027616440] = method;
        mem[1152921512027616416] = method;
    }
