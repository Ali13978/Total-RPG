using UnityEngine;
internal sealed class RealTimeEventListenerHelper.OnRoomConnectedSetChangedCallback : MulticastDelegate
{
    // Methods
    public RealTimeEventListenerHelper.OnRoomConnectedSetChangedCallback(object object, IntPtr method)
    {
        mem[1152921512001578800] = object;
        mem[1152921512001578808] = method;
        mem[1152921512001578784] = method;
    }
