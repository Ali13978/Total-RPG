using UnityEngine;
internal sealed class PlayerManager.FetchCallback : MulticastDelegate
{
    // Methods
    public PlayerManager.FetchCallback(object object, IntPtr method)
    {
        mem[1152921511997350192] = object;
        mem[1152921511997350200] = method;
        mem[1152921511997350176] = method;
    }
