using UnityEngine;
internal sealed class Builder.OnQuestCompletedCallback : MulticastDelegate
{
    // Methods
    public Builder.OnQuestCompletedCallback(object object, IntPtr method)
    {
        mem[1152921511965612080] = object;
        mem[1152921511965612088] = method;
        mem[1152921511965612064] = method;
    }
