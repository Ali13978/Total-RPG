using UnityEngine;
private class GameUI.ItemShop : GameUI.UiBaseState
{
    // Methods
    public GameUI.ItemShop()
    {
    ...
    public override void OnStateBegin(StateMachine.State prevState)
    {
        ...
        this.ShowOnlyThisMenu(menuToShow:  val_1.itemShop);
        TzarGames.Endless.UI.GameUI val_2 = this.UI;
        val_2.itemShop.InitializeItems();
    ...
    public override void OnStateEnd(StateMachine.State nextState)
    {
        ...
        TzarGames.Endless.UI.GameUI val_1 = this.UI;
        this.UI.showMenu(menu:  val_2.itemShop, show:  false);
