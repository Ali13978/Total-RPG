using UnityEngine;
internal sealed class TurnBasedMultiplayerManager.TurnBasedMatchesCallback : MulticastDelegate
{
    // Methods
    public TurnBasedMultiplayerManager.TurnBasedMatchesCallback(object object, IntPtr method)
    {
        mem[1152921512038870704] = object;
        mem[1152921512038870712] = method;
        mem[1152921512038870688] = method;
    }
