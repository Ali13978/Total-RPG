using UnityEngine;
internal sealed class RealTimeMultiplayerManager.FetchInvitationsCallback : MulticastDelegate
{
    // Methods
    public RealTimeMultiplayerManager.FetchInvitationsCallback(object object, IntPtr method)
    {
        mem[1152921512010298032] = object;
        mem[1152921512010298040] = method;
        mem[1152921512010298016] = method;
    }
