using UnityEngine;
internal sealed class VideoManager.CaptureStateCallback : MulticastDelegate
{
    // Methods
    public VideoManager.CaptureStateCallback(object object, IntPtr method)
    {
        mem[1152921512044268464] = object;
        mem[1152921512044268472] = method;
        mem[1152921512044268448] = method;
    }
