using UnityEngine;
internal sealed class RealTimeEventListenerHelper.OnRoomStatusChangedCallback : MulticastDelegate
{
    // Methods
    public RealTimeEventListenerHelper.OnRoomStatusChangedCallback(object object, IntPtr method)
    {
        mem[1152921512001081648] = object;
        mem[1152921512001081656] = method;
        mem[1152921512001081632] = method;
    }
