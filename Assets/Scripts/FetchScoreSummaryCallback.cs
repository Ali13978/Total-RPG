using UnityEngine;
internal sealed class LeaderboardManager.FetchScoreSummaryCallback : MulticastDelegate
{
    // Methods
    public LeaderboardManager.FetchScoreSummaryCallback(object object, IntPtr method)
    {
        mem[1152921511978693680] = object;
        mem[1152921511978693688] = method;
        mem[1152921511978693664] = method;
    }
