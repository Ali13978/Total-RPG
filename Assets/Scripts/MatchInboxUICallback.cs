using UnityEngine;
internal sealed class TurnBasedMultiplayerManager.MatchInboxUICallback : MulticastDelegate
{
    // Methods
    public TurnBasedMultiplayerManager.MatchInboxUICallback(object object, IntPtr method)
    {
        mem[1152921512039367856] = object;
        mem[1152921512039367864] = method;
        mem[1152921512039367840] = method;
    }
