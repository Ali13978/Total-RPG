using UnityEngine;
public sealed class SplineGraph.EdgeCostFunc : MulticastDelegate
{
    // Methods
    public SplineGraph.EdgeCostFunc(object object, IntPtr method)
    {
        mem[1152921511086839184] = object;
        mem[1152921511086839192] = method;
        mem[1152921511086839168] = method;
    }
    public virtual double Invoke(int sourceNode, int targetNode)
    {
        var val_7;
        var val_8;
        var val_9;
    ...
    public virtual System.IAsyncResult BeginInvoke(int sourceNode, int targetNode, System.AsyncCallback callback, object object)
    {
