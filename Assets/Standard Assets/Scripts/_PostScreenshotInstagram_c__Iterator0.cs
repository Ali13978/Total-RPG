using UnityEngine;
private sealed class IOSSocialUseExample.<PostScreenshotInstagram>c__Iterator0 : IEnumerator, IDisposable, IEnumerator<object>
{
    // Fields
    ...
    public IOSSocialUseExample.<PostScreenshotInstagram>c__Iterator0()
    {
    ...
    public bool MoveNext()
    {
        ...
        this.<tex>__0.Apply();
        SA.Common.Pattern.Singleton<SA_EditorAd>.Instance.InstagramPost(texture:  public static IOSSocialManager SA.Common.Pattern.Singleton<IOSSocialManager>::get_Instance(), message:  0);
