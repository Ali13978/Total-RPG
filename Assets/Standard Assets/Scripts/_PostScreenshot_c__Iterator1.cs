using UnityEngine;
private sealed class IOSSocialUseExample.<PostScreenshot>c__Iterator1 : IEnumerator, IDisposable, IEnumerator<object>
{
    // Fields
    ...
    public IOSSocialUseExample.<PostScreenshot>c__Iterator1()
    {
    ...
    public bool MoveNext()
    {
        ...
        this.<tex>__0.Apply();
        SA_EditorAd val_7 = SA.Common.Pattern.Singleton<SA_EditorAd>.Instance;
