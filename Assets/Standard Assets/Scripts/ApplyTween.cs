using UnityEngine;
private sealed class SA_iTween.ApplyTween : MulticastDelegate
{
    // Methods
    public SA_iTween.ApplyTween(object object, IntPtr method)
    {
        mem[1152921510481317920] = object;
        mem[1152921510481317928] = method;
        mem[1152921510481317904] = method;
    }
