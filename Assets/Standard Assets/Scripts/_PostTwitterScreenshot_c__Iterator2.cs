using UnityEngine;
private sealed class IOSSocialUseExample.<PostTwitterScreenshot>c__Iterator2 : IEnumerator, IDisposable, IEnumerator<object>
{
    // Fields
    ...
    public IOSSocialUseExample.<PostTwitterScreenshot>c__Iterator2()
    {
