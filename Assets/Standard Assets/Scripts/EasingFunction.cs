using UnityEngine;
private sealed class SA_iTween.EasingFunction : MulticastDelegate
{
    // Methods
    public SA_iTween.EasingFunction(object object, IntPtr method)
    {
        mem[1152921510480812576] = object;
        mem[1152921510480812584] = method;
        mem[1152921510480812560] = method;
    }
