...
public class SA_UIHightDependence : MonoBehaviour
{
    ...
    // Methods
    public SA_UIHightDependence()
    {
        mem[1152921510513859324] = 0;
        this.InitialScreen = 0;
        mem[1152921510513859308] = 0;
        this.InitialRect = 0;
    }
    private void Awake()
    {
    ...
    public void ApplyTransformation()
    {
        ...
        float val_12 = (float)UnityEngine.Screen.height;
        float val_4 = val_12 / val_1;
        val_1 = val_4 / (V0.16B / S0);
        val_12 = val_12 / val_12;
        CinemachineFreeLook.Orbit val_9 = new CinemachineFreeLook.Orbit(h:  val_1 * val_12, r:  val_4 * (val_12 / val_12));
        this.rect.anchoredPosition = new UnityEngine.Vector2() {x = val_9.m_Height, y = val_9.m_Radius};
        CinemachineFreeLook.Orbit val_11 = new CinemachineFreeLook.Orbit(h:  val_1, r:  val_4);
