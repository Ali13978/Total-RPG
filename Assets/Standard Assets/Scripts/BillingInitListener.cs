using UnityEngine;
public sealed class BillingInitChecker.BillingInitListener : MulticastDelegate
{
    // Methods
    public BillingInitChecker.BillingInitListener(object object, IntPtr method)
    {
        mem[1152921510315314176] = object;
        mem[1152921510315314184] = method;
        mem[1152921510315314160] = method;
    }
